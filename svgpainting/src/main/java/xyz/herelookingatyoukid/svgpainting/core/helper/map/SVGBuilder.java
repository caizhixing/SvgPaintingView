...
public class SVGBuilder {
    ...
    public SVGParser.SVGHandler svgHandler;
    ...
    public SVG build() throws SVGParseException {
        ...
        try {
            svgHandler = new SVGParser.SVGHandler();
            svgHandler.setColorSwap(searchColor, replaceColor, overideOpacity);
            svgHandler.setWhiteMode(whiteMode);
            if (strokeColorFilter != null) {
                svgHandler.strokePaint.setColorFilter(strokeColorFilter);
            }
            if (fillColorFilter != null) {
                svgHandler.fillPaint.setColorFilter(fillColorFilter);
            }
            ...
            final SVG svg = SVGParser.parse(new InputSource(data), svgHandler);
            return svg;
