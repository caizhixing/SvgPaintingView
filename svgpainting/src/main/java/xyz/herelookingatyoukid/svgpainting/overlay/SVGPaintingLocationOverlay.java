package xyz.herelookingatyoukid.svgpainting.overlay;
...
import xyz.herelookingatyoukid.svgpainting.SVGPaintingView;


public class SVGPaintingLocationOverlay extends SVGPaintingBaseOverlay {
    // Model
    ...
    public SVGPaintingLocationOverlay(SVGPaintingView svgMapView) {
        initLayer(svgMapView);
    }

    private void initLayer(SVGPaintingView svgMapView) {
